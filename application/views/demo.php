           ...
           <div class="container-fluid  dashboard-content">
               ...
               <div class="row">
                   ...
                   <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                       <div class="card nav-links" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                           <div class="card-body" id="dashboard-clients">
                   ...
                   <!-- metric -->
                   <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                       <div class="card nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
                           <div class="card-body" id="dashboard-work-orders">
                   ...
                   <!-- metric -->
                   <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                       <div class="card " id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">
                           <div class="card-body" id="dashboard-employees">
               ...
               <div class="row">
                   ...
                   <!-- <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                       <div class="card" id="dashboard-table">
